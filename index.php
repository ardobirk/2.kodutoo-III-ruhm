...
<?php
	//Kood laenatud https://github.com/veebiprogrammeerimine-2015s/4.tund-III-ruhm/blob/master/login.php
	// Loon AB'i ühenduse
...
<body>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" >
  	...
  	<input name="create_nickname" type="text" placeholder="Hüüdnimi"> <?php echo $create_nickname_error; ?> <br><br>
